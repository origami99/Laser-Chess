...
public class ConditionalHidePropertyDrawer : PropertyDrawer
{
    ...
    bool GetConditionalHideAttributeResult(ConditionalHideAttribute condHAtt, SerializedProperty property)
    {
        ...
        if (!property.isArray)
        {
            ...
            string conditionPath = propertyPath.Replace(property.name, condHAtt._conditionalSourceField); //changes the path to the conditionalsource property path
            ...
            if (sourcePropertyValue == null)
            {
                ...
                sourcePropertyValue = property.serializedObject.FindProperty(condHAtt._conditionalSourceField);
            }
        }
        else
        {
    ...
    bool CheckPropertyType(ConditionalHideAttribute condHAtt, SerializedProperty sourcePropertyValue)
    {
        ...
        {                
            ...
            case SerializedPropertyType.Enum:
                return sourcePropertyValue.enumValueIndex == condHAtt._enumIndex;
            default:
